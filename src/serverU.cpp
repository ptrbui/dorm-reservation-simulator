...
int main() {
    ...
    // Load suite information for serverU from suite.txt
    std::string filename = "../data/suite.txt";
    ...
    if ((rv = getaddrinfo(LOCALHOST, SERVER_U_PORT, &hints, &servinfo)) != 0) {
